-- Fix receipt_settings table schema and refresh cache
-- Run this in Supabase SQL Editor

-- First, check if the table exists and drop it if needed for a clean recreation
DROP TABLE IF EXISTS public.receipt_settings CASCADE;

-- Recreate the receipt_settings table with all required columns
...
-- Create default receipt settings for existing users with tax enabled by default
